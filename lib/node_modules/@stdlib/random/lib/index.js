...
*/
setReadOnly( ns, 'arcsine', require( '@stdlib/random/arcsine' ) );
...
*/
setReadOnly( ns, 'bernoulli', require( '@stdlib/random/bernoulli' ) );
...
*/
setReadOnly( ns, 'beta', require( '@stdlib/random/beta' ) );
...
*/
setReadOnly( ns, 'betaprime', require( '@stdlib/random/betaprime' ) );
...
*/
setReadOnly( ns, 'binomial', require( '@stdlib/random/binomial' ) );
...
*/
setReadOnly( ns, 'cauchy', require( '@stdlib/random/cauchy' ) );
...
*/
setReadOnly( ns, 'chi', require( '@stdlib/random/chi' ) );
...
*/
setReadOnly( ns, 'chisquare', require( '@stdlib/random/chisquare' ) );
...
*/
setReadOnly( ns, 'cosine', require( '@stdlib/random/cosine' ) );
...
*/
setReadOnly( ns, 'discreteUniform', require( '@stdlib/random/discrete-uniform' ) );
...
*/
setReadOnly( ns, 'erlang', require( '@stdlib/random/erlang' ) );
...
*/
setReadOnly( ns, 'f', require( '@stdlib/random/f' ) );
...
*/
setReadOnly( ns, 'gamma', require( '@stdlib/random/gamma' ) );
...
*/
setReadOnly( ns, 'gumbel', require( '@stdlib/random/gumbel' ) );
...
*/
setReadOnly( ns, 'invgamma', require( '@stdlib/random/invgamma' ) );
...
*/
setReadOnly( ns, 'kumaraswamy', require( '@stdlib/random/kumaraswamy' ) );
...
*/
setReadOnly( ns, 'laplace', require( '@stdlib/random/laplace' ) );
...
*/
setReadOnly( ns, 'levy', require( '@stdlib/random/levy' ) );
...
*/
setReadOnly( ns, 'logistic', require( '@stdlib/random/logistic' ) );
...
*/
setReadOnly( ns, 'lognormal', require( '@stdlib/random/lognormal' ) );
...
*/
setReadOnly( ns, 'negativeBinomial', require( '@stdlib/random/negative-binomial' ) );
...
*/
setReadOnly( ns, 'normal', require( '@stdlib/random/normal' ) );
...
*/
setReadOnly( ns, 'pareto1', require( '@stdlib/random/pareto-type1' ) );
...
*/
setReadOnly( ns, 'tools', require( '@stdlib/random/tools' ) );
...
*/
setReadOnly( ns, 'uniform', require( '@stdlib/random/uniform' ) );
...
*/
setReadOnly( ns, 'weibull', require( '@stdlib/random/weibull' ) );
