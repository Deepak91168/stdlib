...
> Base `10` [exponential function][exponential-function] of a single-precision floating-point number.
...
Evaluates the base `10` [exponential function][exponential-function] of a single-precision floating-point number.
